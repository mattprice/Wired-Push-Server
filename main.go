...
func (this *WiredConnection) readData() {
...
func (this *WiredConnection) sendAcknowledgement() {
...
func (this *WiredConnection) sendCompatibilityCheck() {
...
func (this *WiredConnection) sendClientInformation() {
...
func (this *WiredConnection) sendLogin(user, password string) {
...
func (this *WiredConnection) setNick(nick string) {
...
func (this *WiredConnection) joinChannel(channel string) {
...
func (this *WiredConnection) sendTransaction(transaction string, parameters ...map[string]string) {
...
func (this *WiredConnection) connectToServer(server string, port int) {
